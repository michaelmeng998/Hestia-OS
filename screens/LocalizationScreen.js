...
import { Button, CheckBox, Container, Content, Footer, FooterTab, List, ListItem, Text } from 'native-base';
        ...
        if (localization.getLanguage() != language) {
            ...
            Alert.alert(
                ...
                [
                  ...
                  {text: localization.ok, onPress: () => this._selectLanguage(language)},
                ],
                {cancelable: false},
            );
        }
            ...
            <Container>
                <Content style={styles.contentContainer}>
                    <List style={styles.locList}>
                        <ListItem style={[styles.flexRow]} onPress={() => 
                        this._confirmSelectLanguage(this.englishAbbr)}>
                            <Text>{localization.english}</Text>
                            { localization.getLanguage() == this.englishAbbr &&
                                <Icon size={25} name="ios-checkmark-circle"></Icon>
                            }
                        </ListItem>
                        <ListItem style={[styles.flexRow]} onPress={() => 
                        this._confirmSelectLanguage(this.chineseAbbr)}>
...
export default connect(null, mapDispatchToProps)(LocalizationScreen);
