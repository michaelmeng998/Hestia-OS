...
import ClientSchedulerStrip from "./ClientSchedulerStrip";
...
class CustomerSchedulerPicker extends React.Component {
  ...
  // For delivery orders
  _isTimeSelected() {
    var timeText = `${localization.pickATime}...`;
  ...
  render() {
    return (
        <View style={[styles.contentContainer]}>
          ...
          {this._isOpen() && (
            <View>
              <Text style={styles.headerStyle}>
                {this._getOrderType(this.props.delivery.isDelivery)}{" "}
                {this.props.delivery.isDelivery ? `${localization.time}:` : `${localization.location}:`}
              </Text>
              {this._isDeliveryAndOpen() && (
                <View>
                  ...
                  {!this._isDeliveryTimeAvailable() && (
                    ...
                    >
                      {localization.noTimesAvail}
                    </Text>
                  )}
                  <View style={styles.lineDividerStyle}></View>
                  <Text style={styles.headerStyle}>{localization.deliveryAddress}</Text>
                  <TouchableOpacity
                  ...
                  >
                    {!this.props.delivery.location.placeID && (
                      <Text style={styles.placeholderText}>
                        {localization.select} {localization.deliveryAddress}
                ...
                <View style={styles.placeholerStyle}>
                  ...
                  {this._isPickupLocationSelected() && (
                    <View>
                      ...
                      <View style={styles.lineDividerStyle}></View>
                      <Text style={styles.headerStyle}>{localization.pickup} {localization.time}:</Text>
              ...
              <View style={styles.lineDividerStyle}></View>
              <Text style={styles.headerStyle}>{localization.noteToChef}</Text>
              <View>
                <TextInput
                  multiline={true}
                  style={[
          ...
          {!this._isOpen() && (
            <Text style={styles.placeholderText}>
              {localization.kitchenClosedToday}
            </Text>
          )}
        </View>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerSchedulerPicker);
